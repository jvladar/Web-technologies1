...
function recalculateModalImages(){
    ...
    mySlides.forEach((item,index)=>{
        ...
        clone.classList.remove("obrazek")
...
function createImageListeners(){
   let isDrag = false
   const imageElements = $("img") // Object{}
...
function playSlides(){
  ...
  window.onbeforeunload = function () {
    ...
    const photos = [...document.getElementsByClassName("obrazek")];
